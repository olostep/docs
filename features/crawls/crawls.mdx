...
sidebarTitle: 'Crawl'
title: Crawl
description: Crawl a website and get all the pages
icon: spider
---

Through the Olostep `/v1/crawls` endpoint you can crawl a website and get all the pages like docs, blogs, and more.

- Crawl a website and get all the pages (or limit the depth of the crawl)
