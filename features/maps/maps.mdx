...
title: Maps
---
The maps endpoint allows you to get all URLs on a certain website. This is useful for content discovery, site structure analysis or decide which of those URLs you want to get the content from.
