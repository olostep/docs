...
title: Maps
---
The Maps endpoint allows you to extract sitemap URLs from any website. Provide a website URL to get a list of all sitemap URLs associated with that domain. This is useful for content discovery and site structure analysis.
