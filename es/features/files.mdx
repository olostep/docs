...
title: "Archivos"
description: "Sube y gestiona archivos JSON para usarlos como contexto en solicitudes de API"
icon: "file-upload"
---
...
Para detalles de la API, consulta la [Referencia de la API del Endpoint de Archivos](/api-reference/files/create).
