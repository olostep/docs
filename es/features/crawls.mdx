...
sidebarTitle: "Crawl"
title: "Crawl"
description: "Rastrea una URL y obtiene el contenido de todas las subpáginas"
icon: "spider"
---
...
Para detalles de la API, consulta la [Referencia de la API del Endpoint de Crawl](/api-reference/crawls/create).
