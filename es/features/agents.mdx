...
Crea un agente con un mensaje en lenguaje natural y un modelo objetivo.
...
data = {
  "prompt": """
    Encuentra empresas de portafolio desde https://www.vcsheet.com/funds y 
...
const res = await fetch('https://api.olostep.com/v1/agents', {
  ...
  body: JSON.stringify({
    prompt: 'Encuentra empresas de portafolio desde https://www.vcsheet.com/funds y escribe en una hoja de Google...',
    model: 'gpt-4.1'
  })
})
...
El precio de los agentes es variable. Se factura por resultado. El precio se negocia entre el cliente y el agente. Comunícate con info@olostep.com para más detalles.