...
title: "Integración de Olostep + Apify"
...
<AccordionGroup>
  ...
  <Accordion title="Base de Conocimiento de Competencia">
...
<AccordionGroup>
  ...
  <Accordion title="Filtra antes de scrapear">
    Evita tareas innecesarias — verifica cambios primero, mantén el estado de desduplicación.
  </Accordion>
  <Accordion title="Almacena contenido grande vía URLs alojadas">
    Usa salidas alojadas para evitar límites de tamaño de carga en flujos de Apify.
  </Accordion>
  <Accordion title="Trata operaciones asíncronas como de larga duración">
