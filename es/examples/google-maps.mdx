---
icon: "map"
sidebarTitle: "Resultados de Google Maps"
title: "Obtener Resultados de Google Maps"
description: "API de SERP para extraer datos de ubicación de Google Maps usando Olostep y un fragmento de código en Python."
---

## Descripción General

La API de Olostep te permite extraer datos estructurados de ubicaciones de Google Maps utilizando analizadores. Estos analizadores transforman el HTML bruto de las páginas de Google Maps en datos JSON limpios y estructurados, listos para análisis o integración en tus aplicaciones.

## Ejemplo de Integración

Para obtener contenido JSON analizado de los resultados de Google Maps, necesitas incluir `json` en el parámetro de formatos y especificar el nombre del analizador `@olostep/google-maps` en el objeto del analizador. Aquí te mostramos cómo recuperar datos de ubicación de Google Maps en un formato estructurado:
...
Cuando haces una solicitud a la API de Olostep con el analizador de Google Maps, recibirás una respuesta JSON como el ejemplo a continuación:
...
- `Detalles del negocio` (nombre, dirección, información de contacto)
- `Información de calificaciones y reseñas`
- `Horarios de apertura`
- `Reseñas de usuarios con texto e imágenes`
- `Lugares similares cercanos`
- `Etiquetas populares y comodidades`

## Respuesta Estructurada: json_content

El campo json_content contiene información detallada sobre la ubicación. Aquí tienes un ejemplo de los datos que puedes esperar:
...
Olostep proporciona un archivo JSON alojado con los datos de ubicación estructurados. Puedes acceder al archivo JSON usando el campo json_hosted_url en la respuesta:

- JSON estructurado: [Ver ejemplo JSON](https://olostep-storage.s3.us-east-1.amazonaws.com/json_y6jwelcpdl.json)

Si también deseas obtener el contenido HTML y Markdown de los datos de ubicación, puedes incluir estos formatos en el parámetro de formatos y Olostep los devolverá en la respuesta y proporcionará URLs alojadas para cada formato.

## Casos de Uso

El analizador de Google Maps es particularmente útil para:

Inteligencia de Negocios: Recopilar datos sobre ubicaciones de competidores, calificaciones y comentarios de clientes
Investigación de Mercado: Analizar reseñas de clientes y sentimientos sobre negocios en áreas específicas
Aplicaciones Basadas en Ubicación: Integrar información detallada de negocios y reseñas de clientes
Análisis Inmobiliario: Recopilar datos sobre comodidades cercanas y negocios locales
SEO Local: Monitorear la presencia de negocios y reseñas de clientes en Google Maps

## Notas Importantes

Parámetro de Idioma: El parámetro ?hl=en establece el idioma en inglés. Ajusta según sea necesario para otros idiomas.

## Conclusión

Usar el analizador de Google Maps con la API de Olostep te permite extraer datos de ubicación estructurados que pueden integrarse fácilmente en tus aplicaciones o utilizarse para análisis. El analizador maneja la compleja tarea de extraer información de las páginas de Google Maps, proporcionándote datos limpios y estructurados.
Para obtener información sobre analizadores disponibles o solicitar un analizador personalizado para tu caso de uso específico, por favor contáctanos en `info@olostep.com`.