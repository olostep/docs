---
icon: "globe"
sidebarTitle: "GEO - Herramientas de Búsqueda AI"
title: "Obtener datos de herramientas de búsqueda AI populares"
description: "Extraer datos estructurados de motores de búsqueda impulsados por AI usando solicitudes por lotes"
---

## Descripción General

Esta guía demuestra cómo usar el endpoint de Batches de Olostep para obtener datos de herramientas de búsqueda AI populares, incluyendo Google AI Mode, Gemini, Microsoft Copilot, ChatGPT, Perplexity y Google AI Overview.

Al aprovechar los analizadores especializados para cada plataforma, puedes extraer resultados de búsqueda estructurados a gran escala, lo que es ideal para:
...
Cada herramienta de búsqueda AI requiere un ID de analizador específico y una estructura de URL. A continuación se muestran las funciones de generación de elementos para cada plataforma:

<Tabs>
  <Tab title="Google AI Mode">
    **ID del Analizador:** `@olostep/google-aimode-results`
  ...
  <Tab title="ChatGPT">
    **ID del Analizador:** `@olostep/chatgpt-results`
  ...
  <Tab title="Perplexity">
    **ID del Analizador:** `@olostep/perplexity-results`
  ...
  <Tab title="Google AI Overview">
    **ID del Analizador:** `@olostep/google-ai-overview-results`
  ...
  <Tab title="Gemini">
    **ID del Analizador:** `@olostep/gemini-results`
  ...
  <Tab title="Microsoft Copilot">
    **ID del Analizador:** `@olostep/microsoft-copilot-results`
   ...
   <Tab title="Grok">
    **ID del Analizador:** `@olostep/grok-results`
...
**Nota:** Después de enviar, [consulta para completar](/use-cases/batch#step-2-monitor-batch-status) para recuperar resultados.
...
La siguiente tabla describe el soporte para búsqueda específica por país y los créditos consumidos por cada analizador.

| Característica       | Google AI Mode | ChatGPT | Perplexity | Google AI Overview | Gemini | Microsoft Copilot | Grok |
| ------------------- | :------------: | :-----: | :--------: | :----------------: | :----: | :---------------: | :--: |
| **País Soportado** |       ✅       |    ✅     |     ✅     |         ✅         |   ✅   |        ✅         |  ✅  |
| **Límite de Tamaño de Lote** |       2500      |    2500     |     2500     |         2500         |   2500   |        1000         |  1000  
| **Créditos**         |       3        |    5    |     3      |         3          |   3    |         3         |  3   |
...
¿Falta algo? Comunícate con `info@olostep.com` para soporte o asistencia en implementaciones personalizadas.