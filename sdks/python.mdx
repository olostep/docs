...
Olostep offers AI a way to search the web and extract structured, clean data in real time from any website

This documentation for the SDK is a work in progress.

## Quick start

```bash
pip install olostep-py
```
...
Handling the error behavior of the API can be complex. The SDK handles error detection for you and returns the following errors:
