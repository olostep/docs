...
icon: "hammer"
title: "Server MCP"
description: "Usa Olostep attraverso il Model Context Protocol per dati web veloci ed efficienti"
---

Il Server MCP di Olostep offre strumenti di accesso web alle tue app AI. Permette alla tua AI di:
1. Cercare sul web per ancorare l'AI a dati del mondo reale (fatti, documenti, eventi)
2. Ottenere il contenuto markdown di qualsiasi pagina web
3. Scoprire e filtrare URL rilevanti all'interno di un sito web.
...
<a href="cursor://anysphere.cursor-deeplink/mcp/install?name=olostep-web&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIm9sb3N0ZXAtbWNwIl0sImVudiI6eyJPTE9TVEVQX0FQSV9LRVkiOiJZT1VSX0FQSV9LRVkifX0%3D">
  <img src="https://cursor.com/deeplink/mcp-install-dark.png" alt="Aggiungi il server MCP di Olostep a Cursor" style={{ maxHeight: 32 }} />
</a>
...
```
- Ricorda di sostituire `YOUR_API_KEY` con la tua chiave API effettiva che puoi ottenere dal [dashboard di Olostep](https://www.olostep.com/dashboard)
