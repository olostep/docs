...
sidebarTitle: "File"
title: "File"
description: "Carica e gestisci file JSON da usare come contesto nelle richieste API"
icon: "file-upload"
---
...
Per i dettagli sull'API, consulta la [Riferimento API dell'Endpoint File](/api-reference/files/create).
...
console.log(`Dimensione file: ${fileInfo.bytes} bytes`)
```
...
# Passaggio 2: Carica i dati JSON batch (salva prima in batch-items.json)
