...
L’endpoint Olostep `/v1/searches` ti consente di cercare sul web con una query in linguaggio naturale e ottenere un elenco deduplicato di link rilevanti con titoli e descrizioni.
...
Per i dettagli dell’API, consulta la [Riferimento API dell’Endpoint di Ricerca](/api-reference/searches/create).
...
| `description` | string | Un breve frammento che descrive il risultato |
