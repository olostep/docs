...
L'endpoint [scrape](../../features/scrapes) di Olostep consente di estrarre contenuti da qualsiasi sito web. Il contenuto in markdown è utile se vuoi fornirlo a un LLM senza tutto l'HTML.
