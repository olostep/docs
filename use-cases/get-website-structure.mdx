...
title: Understand the structure of a website
description: Extract all the urls that make up a website to understand its structure and see which pages you want to get the content from.
---
