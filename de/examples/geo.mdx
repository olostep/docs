---
icon: globe
sidebarTitle: GEO - KI-Suchwerkzeuge
title: Daten von beliebten KI-Suchwerkzeugen abrufen
description: Strukturierte Daten aus KI-gestützten Suchmaschinen mit Batch-Anfragen extrahieren
---

## Überblick

Diese Anleitung zeigt, wie man den Batches-Endpunkt von Olostep verwendet, um Daten von beliebten KI-Suchwerkzeugen wie Google AI Mode, Gemini, Microsoft Copilot, ChatGPT, Perplexity und Google AI Overview abzurufen.

Durch die Nutzung spezialisierter Parser für jede Plattform können Sie strukturierte Suchergebnisse in großem Maßstab extrahieren, was ideal ist für:
...
**Hinweis:** Nach dem Senden [überwachen Sie den Abschluss](/use-cases/batch#step-2-monitor-batch-status), um Ergebnisse abzurufen.
...
| Funktion             | Google AI Mode | ChatGPT | Perplexity | Google AI Overview | Gemini | Microsoft Copilot | Grok |
| ------------------- | :------------: | :-----: | :--------: | :----------------: | :----: | :---------------: | :--: |
| **Land unterstützt** |       ✅       |    ✅     |     ✅     |         ✅         |   ✅   |        ✅         |  ✅  |
| **Batch-Größenlimit** |       2500      |    2500     |     2500     |         2500         |   2500   |        1000         |  1000  
