---
icon: "file-lines"
sidebarTitle: "Haal Markdown van een Website"
title: "Haal de Markdown van een Website"
description: "Leer hoe je inhoud als LLM-vriendelijke markdown uit een webpagina kunt halen."
---

## Overzicht

Olostep's [scrape](../../features/scrapes) endpoint maakt het mogelijk om inhoud van elke website te extraheren. Inhoud in markdown is nuttig als je het aan een LLM wilt voeren zonder alle HTML.
...
- De `requests` en `json` bibliotheken (deze zijn standaard geïnstalleerd met Python, maar je kunt ze installeren met `pip install requests` indien nodig)
