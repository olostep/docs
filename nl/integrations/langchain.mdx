...
<CardGroup cols={2}>
  ...
  <Card title="Batches" icon="layer-group">
    Verwerk tot 10.000 URL's parallel. Batchtaken zijn voltooid in 5-8 minuten
  </Card>
...
Bouw complexe meerstapsworkflows met LangGraph:
...
bedrijven = ["Stripe", "Shopify", "Square"]

for bedrijf in bedrijven:
    result = answer_question.invoke({
        "task": f"Vind informatie over {bedrijf}",
        "json_schema": {
            "ceo": "",
            "headquarters": "",
            "employee_count": "",
...
# Geeft gestructureerde productgegevens terug: prijs, titel, beoordeling, enz.
```
...
<AccordionGroup>
  ...
  <Accordion title="Stel Passende Time-outs In">
  ...
  <Accordion title="Behandel Snelheidslimieten">
    Implementeer exponentiële backoff voor snelheidslimietfouten. De API behandelt de meeste snelheidslimieten intern automatisch.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Answers API" icon="question" href="/features/answers">
    Leer meer over het Answers eindpunt
  </Card>
