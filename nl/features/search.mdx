...
- Ontvang gestructureerde links van over het hele web

Het zal de query semantisch over het web doorzoeken en resultaten retourneren.
...
Stuur een query in natuurlijke taal en ontvang een lijst van relevante links.
  ...
  "result": {
    ...
    "links": [
      ...
      },
      {
        ...
        "description": "Een diepgaande blik op de 48 meest veelbelovende zoekmachine startups..."
      },
      {
        "url": "https://clutch.co/seo-firms/startups",
        "title": "Top 30 SEO Companies for Startups - Mar 2026 Rankings",
        "description": "Verbind met de beste SEO bedrijven..."
      }
    ]
  }
}
