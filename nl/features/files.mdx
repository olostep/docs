...
console.log(`Download-URL verloopt over: ${customDownloadInfo.expires_in} seconden`)
```
...
console.log(`Batch bestand succesvol geüpload: ${fileInfo.id}`)
console.log(`Bestandsgrootte: ${fileInfo.bytes} bytes`)
...
# Stap 2: Upload batch JSON-data (eerst opslaan in batch-items.json)
