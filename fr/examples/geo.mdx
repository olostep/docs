---
icon: "globe"
sidebarTitle: "GEO - Outils de recherche AI"
title: "Récupérer des données à partir d’outils de recherche AI populaires"
description: "Extraire des données structurées des moteurs de recherche alimentés par l’AI en utilisant des requêtes par lots"
---

## Vue d'ensemble

Ce guide montre comment utiliser le point de terminaison Batches d'Olostep pour récupérer des données à partir d'outils de recherche AI populaires, y compris Google AI Mode, Gemini, Microsoft Copilot, ChatGPT, Perplexity et Google AI Overview.

En utilisant des analyseurs spécialisés pour chaque plateforme, tu peux extraire des résultats de recherche structurés à grande échelle, ce qui est idéal pour :
...
<Tabs>
  ...
  <Tab title="ChatGPT">
    **ID d'analyseur :** `@olostep/chatgpt-results`
  ...
  <Tab title="Perplexity">
    **ID d'analyseur :** `@olostep/perplexity-results`
  ...
  <Tab title="Google AI Overview">
    **ID d'analyseur :** `@olostep/google-ai-overview-results`
  ...
  <Tab title="Gemini">
    **ID d'analyseur :** `@olostep/gemini-results`
  ...
  <Tab title="Microsoft Copilot">
    **ID d'analyseur :** `@olostep/microsoft-copilot-results`
   ...
   <Tab title="Grok">
    **ID d'analyseur :** `@olostep/grok-results`
...
**Note :** Après soumission, [vérifie l'achèvement](/use-cases/batch#step-2-monitor-batch-status) pour récupérer les résultats.
...
| Fonctionnalité             | Google AI Mode | ChatGPT | Perplexity | Google AI Overview | Gemini | Microsoft Copilot | Grok |
| ------------------- | :------------: | :-----: | :--------: | :----------------: | :----: | :---------------: | :--: |
| **Pays supporté** |       ✅       |    ✅     |     ✅     |         ✅         |   ✅   |        ✅         |  ✅  |
| **Limite de taille de lot** |       2500      |    2500     |     2500     |         2500         |   2500   |        1000         |  1000  
| **Crédits**         |       3        |    5    |     3      |         3          |   3    |         3         |  3   |
