...
<CardGroup cols={2}>
  ...
  <Card title="Google Maps" icon="map">
    ...
    Extraire : informations commerciales, avis, évaluations, localisation
  </Card>
...
<AccordionGroup>
  ...
  <Accordion title="Le Scrape Retourne un Contenu Vide">
