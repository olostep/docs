...
title: "Intégration Olostep + LangChain"
...
Récupère ta clé API depuis le [Tableau de bord Olostep](https://olostep.com/dashboard).
...
result = asyncio.run(answer_question.ainvoke({
    "task": "Trouver le PDG et le siège social de Stripe",
    "json_schema": {
        "ceo_name": "",
        "headquarters": "",
        "founded_year": ""
