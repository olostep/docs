...
Il effectuera une recherche sémantique de la requête sur le web et renverra les résultats.

Pour les détails de l'API, voir la [Référence de l'API du point de terminaison de recherche](/api-reference/searches/create).
