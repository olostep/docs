...
<Check>
**All endpoints now support metadata** on create and read operations.
</Check>

Metadata allows you to attach custom key-value pairs to Olostep resources like scrapes, batches, crawls, maps, and answers. This is useful for tracking, filtering, organizing, and storing context alongside your API requests.
...
<Info>
**Currently available for:** [Batches](/api-reference/batches/create) only.
