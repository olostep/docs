...
<Info>
This design is inspired by [Stripe's API philosophy](https://docs.stripe.com/payments-api/tour#everything-is-an-object) — everything is an object with a lifecycle.
</Info>
