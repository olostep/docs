...
url = 'https://en.wikipedia.org/wiki/Alexander_the_Great'; # Change this to the URL you want to scrape
...
def start_olostep(url)
  ...
  uri = URI.parse("https://agent.olostep.com/olostep-p2p-incomingAPI") # endpoint API
