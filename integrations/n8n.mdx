...
The integration provides 5 powerful operations for automated web data extraction:
...
<CardGroup cols={2}>
  ...
  <Card title="Search" icon="search">
    Search the Web with AI and get structured results with sources and citations
  </Card>
